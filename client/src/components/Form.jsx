    ...
    >
      ...
      <div>
        ...
        <textarea
          ...
          value={form.projects}
          onChange={handleChange}
          placeholder={`e.g.\n- AI Resume Generator using React + LLaMA 3\n- ML-based Crop Disease Classifier`}
          className="w-full border border-gray-300 p-2 rounded"
          rows={3}
        />
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          onChange={handleChange}
          placeholder="e.g. Winner of Smart India Hackathon 2023, GirlScript Finalist"
          className="w-full border border-gray-300 p-2 rounded"
          rows={2}
        />
      </div>
      ...
      <div className="flex gap-4">
        <button
          ...
          className="flex-1 bg-blue-700 hover:bg-blue-800 text-white py-2 px-4 rounded"
